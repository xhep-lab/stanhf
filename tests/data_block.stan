...
tuple(vector[2], vector[2]) lu_singlechannel_signal_histosys_k_histosys; // from HistoSys.stan_data [modifier.py:L276]
tuple(real, real) lu_singlechannel_signal_normsys_k_normsys; // from NormSys.stan_data [modifier.py:L331]
vector[2] rel_error_singlechannel_signal_shapesys_k_shapesys; // from ShapeSys.stan_data [modifier.py:L226]
vector[2] stdev_singlechannel_signal_staterror_k_staterror; // from StatError.stan_data [modifier.py:L151]
tuple(vector[2], vector[2]) lu_singlechannel_background_histosys_k_histosys; // from HistoSys.stan_data [modifier.py:L276]
vector[2] stdev_singlechannel_background_staterror_l_staterror; // from StatError.stan_data [modifier.py:L151]
tuple(vector[2], vector[2]) lu_secondchannel_signal_histosys_k_histosys; // from HistoSys.stan_data [modifier.py:L276]
vector[2] stdev_secondchannel_signal_staterror_m_staterror; // from StatError.stan_data [modifier.py:L151]
tuple(vector[2], vector[2]) lu_secondchannel_background_histosys_k_histosys; // from HistoSys.stan_data [modifier.py:L276]
vector[2] stdev_secondchannel_background_staterror_n_staterror; // from StatError.stan_data [modifier.py:L151]
