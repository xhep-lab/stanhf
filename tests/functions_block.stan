...
real factor_interp(real alpha, tuple(real, real) lu) {
  ...
  vector[6] b = [lu.2 - 1., lu.1 - 1., log(lu.2) * lu.2, -log(lu.1) * lu.1,
                 log(lu.2) ^ 2 * lu.2, log(lu.1) ^ 2 * lu.1]';
  
  matrix[6, 6] m = [[15. / 16., -15. / 16., -7. / 16., -7. / 16., 1. / 16.,
                     -1. / 16.],
                    [3. / 2., 3. / 2., -9. / 16., 9. / 16., 1. / 16.,
                     1. / 16.],
                    [-5. / 8., 5. / 8., 5. / 8., 5. / 8., -1. / 8., 1. / 8.],
                    [-3. / 2., -3. / 2., 7. / 8., -7. / 8., -1. / 8.,
                     -1. / 8.],
                    [3. / 16., -3. / 16., -3. / 16., -3. / 16., 1. / 16.,
                     -1. / 16.],
                    [1. / 2., 1. / 2., -5. / 16., 5. / 16., 1. / 16.,
                     1. / 16.]];
